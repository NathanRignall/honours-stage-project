...
# rt-pi4-signal-times
plt.figure(figsize=(8,3))
rt_pi4_signal_times = np.abs(data['rt-pi4-signal-times-child']['time'] - data['rt-pi4-signal-times-parent']['time'])
plt.plot(rt_pi4_signal_times, label='Latency')
plt.plot([np.mean(rt_pi4_signal_times)] * len(rt_pi4_signal_times), label='Average', linestyle='--')
rt_pi4_signal_times_jitter = np.abs(rt_pi4_signal_times - np.roll(rt_pi4_signal_times, 1))
plt.plot(rt_pi4_signal_times_jitter, label='Jitter')
plt.legend()
plt.grid()
plt.margins(0)
plt.xlim(0, 3000)
...
plt.plot(rt_pi4_signal_times, label='Signal')
plt.legend()
plt.grid()
plt.margins(0)
plt.xlim(0, 3000)
...
rt_pi4_socket_times_blocking_hist, rt_pi4_socket_times_blocking_bins = np.histogram(rt_pi4_socket_times_blocking, bins=range(0, 101, 1))
rt_pi4_mem_times_hist, rt_pi4_mem_times_bins = np.histogram(rt_pi4_mem_times, bins=range(0, 101, 1))
rt_pi4_signal_times_hist, rt_pi4_signal_times_bins = np.histogram(rt_pi4_signal_times, bins=range(0, 101, 1))
plt.figure(figsize=(8,3))
plt.semilogy(rt_pi4_socket_times_bins[:-1], rt_pi4_socket_times_hist, label='Socket')
plt.semilogy(rt_pi4_mem_times_bins[:-1], rt_pi4_mem_times_hist, label='Memory')
plt.semilogy(rt_pi4_signal_times_bins[:-1], rt_pi4_signal_times_hist, label='Signal')
plt.legend()
plt.grid()
plt.margins(0)
plt.xlim(0, 100)
...
plt.savefig('../rt-pi4-compare-times-histogram.pdf', format='pdf', bbox_inches='tight')
plt.close()
...
plt.plot(rt_pi4_signal_times_jitter, label='Signal')
plt.legend()
plt.grid()
plt.margins(0)
plt.xlim(0, 3000)
...
# pi5-signal-times
plt.figure(figsize=(8,3))
pi5_signal_times = np.abs(data['pi5-signal-times-child']['time'] - data['pi5-signal-times-parent']['time'])
plt.plot(pi5_signal_times, label='Latency')
plt.plot([np.mean(pi5_signal_times)] * len(pi5_signal_times), label='Average', linestyle='--')
pi5_signal_times_jitter = np.abs(pi5_signal_times - np.roll(pi5_signal_times, 1))
plt.plot(pi5_signal_times_jitter, label='Jitter')
plt.legend()
plt.grid()
plt.margins(0)
plt.xlim(0, 3000)
...
plt.xlabel('Time Step')
plt.ylabel('Latency (us)')
plt.savefig('../pi5-signal-times.pdf', format='pdf', bbox_inches='tight')
plt.close()
...
plt.plot(pi5_signal_times, label='Signal')
plt.legend()
plt.grid()
plt.margins(0)
plt.xlim(0, 3000)
...
plt.plot(pi5_signal_times_jitter, label='Signal')
plt.legend()
plt.grid()
plt.margins(0)
plt.xlim(0, 3000)
...
# dev-signal-times
# plt.figure(figsize=(8,3))
# dev_signal_times = np.abs(data['dev-signal-times-child']['time'] - data['dev-signal-times-parent']['time'])
# plt.plot(dev_signal_times, label='Latency')
# plt.plot([np.mean(dev_signal_times)] * len(dev_signal_times), label='Average', linestyle='--')
# dev_signal_times_jitter = np.abs(dev_signal_times - np.roll(dev_signal_times, 1))
# plt.plot(dev_signal_times_jitter, label='Jitter')
# plt.legend()
# plt.grid()
# plt.margins(0)
# plt.xlim(0, 3000)
...
# plt.xlabel('Time Step')
# plt.ylabel('Latency (us)')
# plt.savefig('../dev-signal-times.pdf', format='pdf', bbox_inches='tight')
# plt.close()
