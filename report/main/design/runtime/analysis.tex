...
To select the most optimal environment to develop the software infrastructure upon, a series of benchmarking activities were carried out. These focused on evaluating the operating systems and hypervisors which could operate in a real time environment. The search was restricted to free and open source software which supports the Raspberry Pi Compute Module 4.
...
% Why xen? Might be better to put in a differnet section
