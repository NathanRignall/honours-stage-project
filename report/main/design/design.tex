...
\textcolor{red}{A little intro to the design... First did the hardware as the longest lead time}

This chapter first shows the designs for the development hardware and test harness. These were completed first due the longer lead time on hardware components. The design for the software infrastructure in then expressed through various system diagrams and UML diagrams.

Expirements for latency on target hadrware with real-time operatings systems

investigate latencies over communication mediums on Linux
