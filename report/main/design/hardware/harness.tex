...
\subsection{Development Test Harness}
...
The chosen logic analyser software was PulseView as it is open-source and supports many different logic analyser devices \autocite{PulseViewSigrok}. Boards which use the RP2040 microprocessor (Pi Pico) can use the ULA logic analyser firmware \autocite{domnikovDotcypressUla2024}.
