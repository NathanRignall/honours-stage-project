...
\autoref{fig:TestHardwareFrameMount} displays the frame mount, also designed in Fusion 360 and 3D printed, to hold the components together in a single package.
