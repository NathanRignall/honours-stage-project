...
Through the literature review, the principals of dynamic software updates that were relevant to real-time systems were investigated; hardware handover, clock synchronisation, state continuity and optimal time. These principals were then successfully applied onto the example hardware implementation and validated with two experiments, answering the research questions.
