...
# draw lines at Configuration Changes
plt.axvline(x=5000, color='black', linestyle='--', label='Configuration Change')
plt.axvline(x=15000, color='black', linestyle='--', label='_Update')
plt.axvline(x=45000, color='black', linestyle='--', label='_Update')
plt.axvline(x=60000, color='black', linestyle='--', label='_Update')
...
plt.plot(elafry_three_four, label='State Time')
plt.plot(elafry_four_five, label='Management Time')
plt.axvline(x=15000, color='black', linestyle='--', label='Configuration Change')
plt.legend(loc='upper right')
plt.grid()
plt.margins(0)
plt.ylim(0, 1500)
...
# plot plant again but zoom at x = 7000 to 8500
plt.figure(figsize=(8,3))
plt.plot(data['elafry-plant-data']['position'], label='Height (m)')
plt.plot(data['elafry-plant-data']['thrust'], label='Thrust (N)')
plt.plot(data['elafry-plant-data']['set'], label='Height Setpoint (m)')
plt.plot(new_loop, label='Loop')
# plt.axvline(x=update_pos, color='black', linestyle='--', label='Update')
plt.axvline(x=8192, color='red', linestyle='--', label='Missed Execution')
plt.legend()
plt.grid()
plt.margins(0)
plt.xlabel('Time Step')
...
plt.ylim(0, 25)
plt.savefig('../elafry-plant-data-zoom2.pdf', format='pdf', bbox_inches='tight')
plt.close()
...
# draw lines at Configuration Changes
plt.axvline(x=5, color='black', linestyle='--', label='Configuration Change')
plt.axvline(x=1005, color='black', linestyle='--', label='_Update')
plt.axvline(x=2005, color='black', linestyle='--', label='_Update')
plt.axvline(x=2100, color='black', linestyle='--', label='_Update')
plt.legend(loc='upper right')
plt.grid()
plt.margins(0)
plt.ylim(0, 1500)
...
plt.plot(elafry_harness_three_four, label='State Time')
plt.plot(elafry_harness_four_five, label='Management Time')
plt.axvline(x=1005, color='black', linestyle='--', label='Configuration Change')
plt.legend(loc='upper right')
plt.grid()
plt.margins(0)
plt.ylim(0, 1500)
