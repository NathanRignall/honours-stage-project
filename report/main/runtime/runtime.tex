...
To select the most optimal environment to develop the software infrastructure upon, a serieis of benchmarking activties were carried out. These focused on evaluating operating systems and hypervisors which could operate in a real time environment. The search was restricted to free and open source software which supports the Rasberry Pi Compute Module 4.

EXPLAIN THE VIRTUALISATION EXTENSIONS AND VIRTUALISATION

\autocite{abeniUsingXenKVM2020} compiled a similar study into the real time performance of open source hypervisors. Comparing KVM and Xen on various intel x86 processors.
...
This is because KVM is implemented ontop of the Linux kernel.
