...
\textbf{Real-Time}
A real-time system is defined as a system which requires correct logical operation with compeltion a configured deadline. In contrsast to a non-real-time system which has no configured deadlines. \cite{kaviRealTimeSystems2009}
